...
namespace AV.Persistence.EntityFramework.Migrations
{
    ...
    [Migration("20220228222100_AddValuationSourceonComparableRecords")]
    partial class AddValuationSourceonComparableRecords
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AV.Common.Entities.Account", b =>
                {
                    ...
                    b.Property<int>("DetailedReportsLimit")
                        .HasColumnType("int");

                    b.Property<double>("DiscountPerReferral")
                    ...
                    b.Property<int>("InstantReportsLimit")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MaximumSubAccounts")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AV.Common.Entities.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AV.Common.Entities.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AV.Common.Entities.BasketItemInputData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AV.Common.Entities.Comparable", b =>
                {
                    ...
                    b.Property<int>("ValuationSource")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AV.Common.Entities.Package", b =>
                {
                    ...
                    b.Property<int?>("DetailedReportLimit")
                        .HasColumnType("int");

                    b.Property<double>("DiscountPerReferral")
                        .HasColumnType("double");

                    b.Property<int?>("InstantReportLimit")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AV.Common.Entities.PaymentHistory", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("PaymentTokenExpiry")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("AV.Common.Entities.ProductFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AV.Common.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "b8f04510-da15-41f7-94d4-1ca3f5183b2b",
                            Name = "admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "32480359-9e47-4691-96ff-9ea659700639",
                            Name = "client",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f9b2c069-189b-4d95-a65a-222f358710f0",
                            Name = "analyst",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f610b9bf-db52-4421-9a64-475dae7257d4",
                            Name = "manager",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "d58dcd01-f4c8-4f8b-acde-c84f680f5aba",
                            Name = "user",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("AV.Contracts.Enums.BasketStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AV.Common.Entities.Account", b =>
                {
                    ...
                    b.HasOne("AV.Common.Entities.SubscriptionOption", "SubscriptionOption")
                        .WithMany()
            ...
            modelBuilder.Entity("AV.Common.Entities.Basket", b =>
                {
                    b.HasOne("AV.Contracts.Enums.BasketStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("AV.Common.Entities.BasketItem", b =>
                {
                    b.HasOne("AV.Common.Entities.Basket", "Basket")
                        .WithMany("Items")
                        .HasForeignKey("BasketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AV.Common.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("AV.Common.Entities.BasketItemInputData", b =>
                {
                    b.HasOne("AV.Common.Entities.BasketItem", "BasketItem")
                        .WithOne("InputData")
                        .HasForeignKey("AV.Common.Entities.BasketItemInputData", "BasketItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AV.Common.Entities.PackageFeature", b =>
                {
                    b.HasOne("AV.Common.Entities.Package", "Package")
                        .WithMany("Features")
                        .HasForeignKey("PackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AV.Common.Entities.User", b =>
                {
                    b.HasOne("AV.Common.Entities.Account", null)
                        .WithMany("Members")
                        .HasForeignKey("AccountId");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("AV.Common.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AV.Common.Entities.UserRole", b =>
                {
                    b.HasOne("AV.Common.Entities.Role", "Role")
                        .WithMany("Users")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AV.Common.Entities.Comparable", b =>
                {
                    b.Navigation("ComparableResults");
