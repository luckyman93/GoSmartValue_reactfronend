...
namespace AV.Infrastructure.Services
{
    public class DocumentStorage
    {
        ...
        public void UploadEncryptedFile(string key, string bucketName,
        ...
        public void DownloadEncryptedObject(string key, string bucketName,
...
(acl) => acl.Entity == $"user-{userEmail}"))
        ...
        private void ViewBucketIamMembers(string bucketName)
        {
            ...
            {
                Console.WriteLine($"  UserRole: {binding.Role}");
        ...
        private void GenerateV4SignedPutUrl(string bucketName, string objectName)
        {
            ...
            string url = urlSigner.Sign(bucketName, objectName, TimeSpan.FromHours(1), HttpMethod.Put);
